		...
		<div class="flex flex-col">
				...
				<div
					...
					<div class="w-full my-auto py-6 flex flex-col justify-center gap-2">
						<div
							class="w-full flex sm:flex-row xs:flex-col gap-2 justify-center">
							<div class="w-full">
								<dl
									...
									<div class="flex flex-col pb-3">
										...
										<dd class="text-lg font-semibold">{{(user.profile.name)}}</dd>
									</div>
									...
									<dd class="text-lg font-semibold">{{ new Date(user.profile.date_of_birth).toLocaleDateString('en-GB') }}</dd>
								</div>
									<div class="flex flex-col py-3">
										<dt
											class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">
										...
										<dd class="text-lg font-semibold">{{user.profile.sex==0?'male':user.profile.sex==1?'female':'orther'}}</dd>
									</div>
								</dl>
							</div>
							<div class="w-full">
								<dl
									...
									<div class="flex flex-col pt-3" v-show="!!user.profile.phone">
										<dt 
											class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">
											Phone Number
										</dt>
										<dd class="text-lg font-semibold">{{user.profile.phone}}</dd>
									</div>
									<div class="flex flex-col pt-3" v-show="user.profile.email">
										<dt
											class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">
											Email
										</dt>
